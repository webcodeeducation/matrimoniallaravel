...
Route::group(['middleware' => ['adminSess']], function (){
    ...
    Route::get('/admin/paymentsetup', "PaymentController@setup")->name('payment.gateway');
    Route::post('/admin/paymentsetup', "PaymentController@add_payment")->name('payment.gateway');
    Route::get('/admin/religion', "InformationController@religion")->name('information.religion');
    Route::post('/admin/addreligion', "InformationController@addreligion")->name('information.religion');

    Route::get('/admin/students', "InformationController@students")->name('information.students');
    Route::post('/admin/addstudent', "InformationController@addstudent")->name('information.addstudent');

    Route::get('/admin/logout', "LogoutController@adminLogout")->name('logout.admin');

    /*Testing*/

Route::get('/admin/demostudents', "DemoController@demostudents");
Route::get('/admin/demoreligions', "DemoController@demorelogions");
...
/*Govinda Works*/
    Route::get('/admin/deletestudent/{id}', "InformationController@deleteStudent");
    Route::get('/admin/showstudent/{id}', "InformationController@showstudent");
    Route::post('/admin/update-govinda/{id}', "InformationController@update-govinda");