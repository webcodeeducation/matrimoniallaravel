	...
	<div class="panel-body">
		<div class="row">
			...
			<div class="tile tile-primary">
				...
				<div class="tile-body">
					<span><img src="{{asset('public/images')}}/admin/registration-user.png"></span>
		...
		<div class="col-lg-3 col-md-3 col-sm-6" class="activity-banner">
			<div class="tile tile-primary">
				...
				<div class="tile-body">
					<span><img src="{{asset('public/images')}}/admin/report-user.png"></span>
		...
		<div class="col-lg-3 col-md-3 col-sm-6" class="activity-banner">
			<div class="tile tile-primary">
				...
				<div class="tile-body">
					<span><img src="{{asset('public/images')}}/admin/user-icon.png"></span>
		...
		<div class="col-lg-3 col-md-3 col-sm-6" class="activity-banner">
			<div class="tile tile-primary">
				...
				<div class="tile-body">
					<span><img src="{{asset('public/images')}}/admin/active-user.png"></span>
