		...
		<div class="row">
			<div class="modal-content" id="login-panel">
				<div class="modal-header modal-icon">
					<center>
						<img src="{{asset('public/images')}}/defaultpic/ristaguru.png" class="img-circle1" alt="Login" width="300">
						<!--span><img src="{{asset('public/images')}}/defaultpic/ristaguru.jpeg" class="img-circle1" alt="Login" width="60" height="60"></span> LOGIN</h4-->
					</center>
				</div>
