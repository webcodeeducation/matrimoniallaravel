		...
		<div id="myCarousel" class="carousel slide banner-mid" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<a href="#"><img src="{{asset('public/images')}}/defaultpic/couple-love.jpg" alt="LOVE"></a>
				</div>
				<div class="item">
					<a href="#"><img src="{{asset('public/images')}}/defaultpic/desi-wedding.jpg" alt="DESI WEDDING"></a>
				</div>
				<div class="item">
					<a href="#"><img src="{{asset('public/images')}}/defaultpic/love-couple.jpg" alt="LOVE"></a>
				</div>
			</div>
		</div>
	</div>
		...
		@foreach($users as $user)
			<a href="/profile/{{$user->uname}}">
				<div class="col-sm-5 col-md-5 searched-profile">
					<img class="thumbnail user-image" src="{{asset('public/images')}}/{{$user->propic}}">
					<div class="user-info">
