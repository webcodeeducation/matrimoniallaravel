...
<head>
    ...
    <script src="{{asset('public/js')}}/userscript.js"></script>
</head>
<body>
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('public.index')}}"><span><img src="{{asset('public/images')}}/defaultpic/ristaguru.png" alt="MATRIMONIAL"></span></a>
        </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header modal-icon">
                    ...
                    <center>
                        <h4><span><img src="{{asset('public/images')}}/defaultpic/ristaguru.png" class="img-responsive" alt="Login" width="60" height="60">
							</span> LOGIN</h4>
                    </center>
                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header modal-icon">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <center>
                        <h4><span><img src="{{asset('public/images')}}/defaultpic/ristaguru.png" class="img-responsive" alt="Signup" width="60" height="60"></span> SIGNUP</h4>
                    </center>
                </div>
                <div class="modal-body">
