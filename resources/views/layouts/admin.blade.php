...
<head>
	...
	<script type="text/javascript" src="{{asset('public/js')}}/adminscript.js"></script>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
		 		<div class="navbar-header">
					...
					<a class="navbar-brand" href="{{route('admin.index')}}"><span><img src="{{asset('public/images')}}/defaultpic/ristaguru.png" alt="MATRIMONIAL" height="100%"></span></a>
						...
						<div class="nav-side-menu col-md-12">
							<div class="menu-list">
								<ul class="menu-content collapse-out" id="left-menu-content">
									...
									<li><a href="{{route('information.religion')}}">Religion</a></li>
									<li><a href="{{route('payment.gateway')}}">Payment Gateway</a></li>
									<li><a href="{{route('information.students')}}">Students</a></li>
								</ul>
							</div>
						</div>
					</div>
