...
class PaymentController extends Controller
{
    public function setup(Request $request)
    {
        ...
        $psList = PoliceStation::where('district', $addresses->districtId)
                                    ->get();
    	return view('admin.information.payment-setup')
    			->with('psList', $psList)
        ...
        return view('admin.information.payment-setup')->with($data);
    }
    public function add_payment(Request $request)
    {
        ...
        $ps->api_key = $request->api_key;
        $ps->api_secret = $request->api_secret;
        $ps->save();
        Session::flash('alert-success', 'Payment Gateway Added Successfully.');
